...
data = {
  ...
  'appointments[0][StartDate]': '2024-03-17T09:00:00',
  'appointments[0][EndDate]': '2024-03-17T11:30:00',
  ...
  'appointments[1][StartDate]': '2024-03-17T11:30:00',
  'appointments[1][EndDate]': '2024-03-17T14:00:00',
  ...
  'appointments[2][ID]': '1eb7272c-d8b6-4f3e-be86-a95fd1453350',
  'appointments[2][RecurrenceInfo]': '',
  'appointments[2][AppointmentType]': '0',
  'appointments[2][StartDate]': '2024-03-18T21:30:00',
  'appointments[2][EndDate]': '2024-03-19T00:00:00',
  ...
  'appointments[3][StartDate]': '2024-03-19T21:30:00',
  'appointments[3][EndDate]': '2024-03-20T00:00:00',
...
data2 = {
  'appointments[0][ID]': '1eb7272c-d8b6-4f3e-be86-a95fd1453350',
  'appointments[0][RecurrenceInfo]': '',
  'appointments[0][AppointmentType]': '0',
  'appointments[0][StartDate]': '2024-02-26T21:30:00',
  'appointments[0][EndDate]': '2024-02-27T00:00:00',
  'appointments[0][Location]': 'PAC Small Gym',
  'appointments[0][Subject]': '',
  'appointments[0][AllDay]': 'false',
  'appointments[0][ResourceId]': '',
  ...
  'appointments[0][InstructorId]': '00000000-0000-0000-0000-000000000000',
  'appointments[0][IsRecurring]': 'false',
  'appointments[1][ID]': 'c21623e3-bfdb-4f9a-aa01-55bf30d257ae',
  'appointments[1][RecurrenceInfo]': '',
  'appointments[1][AppointmentType]': '0',
  'appointments[1][StartDate]': '2024-02-28T22:30:00',
  'appointments[1][EndDate]': '2024-02-29T00:15:00',
  'appointments[1][Location]': 'PAC Small Gym',
  'appointments[1][Subject]': '',
  'appointments[1][AllDay]': 'false',
  'appointments[1][ResourceId]': '',
  ...
  'appointments[2][RecurrenceInfo]': '',
  'appointments[2][AppointmentType]': '0',
  'appointments[2][StartDate]': '2024-02-29T21:30:00',
  'appointments[2][EndDate]': '2024-03-01T00:00:00',
  'appointments[2][Location]': 'PAC Small Gym',
  'appointments[2][Subject]': '',
  'appointments[2][AllDay]': 'false',
  'appointments[2][ResourceId]': '',
  ...
  'appointments[2][InstructorId]': '00000000-0000-0000-0000-000000000000',
  'appointments[2][IsRecurring]': 'false',
  'appointments[3][ID]': 'f922e321-ffda-4f01-a77a-921f086808e9',
  'appointments[3][RecurrenceInfo]': '',
  'appointments[3][AppointmentType]': '0',
  'appointments[3][StartDate]': '2024-03-01T15:01:00',
  'appointments[3][EndDate]': '2024-03-01T17:00:00',
  'appointments[3][Location]': 'CIF Gym 1',
  'appointments[3][Subject]': '',
  'appointments[3][AllDay]': 'false',
  'appointments[3][ResourceId]': '',
  'appointments[3][Status]': '0',
  ...
  'appointments[3][InstructorId]': '00000000-0000-0000-0000-000000000000',
  'appointments[3][IsRecurring]': 'false',
  'appointments[4][ID]': '2d2560b0-c689-4628-bcc3-8a19e7c2852e',
  'appointments[4][RecurrenceInfo]': '',
  'appointments[4][AppointmentType]': '0',
  'appointments[4][StartDate]': '2024-03-01T15:02:00',
  'appointments[4][EndDate]': '2024-03-01T17:00:00',
  'appointments[4][Location]': 'CIF Gym 2',
  ...
  'appointments[5][ID]': '1eb7272c-d8b6-4f3e-be86-a95fd1453350',
  'appointments[5][RecurrenceInfo]': '',
  'appointments[5][AppointmentType]': '0',
  'appointments[5][StartDate]': '2024-03-01T21:30:00',
  'appointments[5][EndDate]': '2024-03-02T00:00:00',
  'appointments[5][Location]': 'PAC Small Gym',
  ...
  'appointments[6][ID]': '46d677a7-5fa7-4d66-a265-b3b337a5b71f',
  'appointments[6][RecurrenceInfo]': '',
  'appointments[6][AppointmentType]': '0',
  'appointments[6][StartDate]': '2024-03-03T09:00:00',
  'appointments[6][EndDate]': '2024-03-03T11:30:00',
  'appointments[6][Location]': 'PAC Small Gym',
  ...
  'appointments[7][ID]': '4f418d4d-0c56-45e8-9ac2-d52a17e878fa',
  'appointments[7][RecurrenceInfo]': '',
  'appointments[7][AppointmentType]': '0',
  'appointments[7][StartDate]': '2024-03-03T11:30:00',
  'appointments[7][EndDate]': '2024-03-03T14:00:00',
  'appointments[7][Location]': 'PAC Small Gym',
...
specified_time = "9:30 PM - 12:00 AM"
